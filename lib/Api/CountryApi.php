...
class CountryApi
{
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\CountryDto[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getCountriesWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\CountryDto[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\CountryDto[]',
    ...
    protected function getCountriesRequest()
    {
        ...
        $resourcePath = '/v1/external/country';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
