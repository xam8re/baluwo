...
/**
 * CashPowerOrderDto Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CashPowerOrderDto extends OrderDto 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CashPowerOrderDto';
    ...
    public function setMeterId($meter_id)
    {
        ...
        if (!is_null($meter_id) && (!preg_match("/[0-9]{7,14}/", $meter_id))) {
            throw new \InvalidArgumentException("invalid value for $meter_id when calling CashPowerOrderDto., must conform to the pattern /[0-9]{7,14}/.");
        }
